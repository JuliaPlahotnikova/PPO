        ...
        Dexter.withActivity(this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
            .withListener(object : PermissionListener {
                override fun onPermissionGranted(response: PermissionGrantedResponse?) {
                    ...
                    findViewById<Button>(R.id.playAction).setOnClickListener{
                        musicManager.sortStart()
                        findViewById<Button>(R.id.btn_play).setBackgroundResource(R.drawable.ic_baseline_pause_24)
                    }
                    findViewById<Button>(R.id.shuffleAction).setOnClickListener{
